...
export type GetLessonBySlugQuery = {
  ...
  lesson?: {
    ...
    teacher?: { __typename?: 'Teacher'; bio: string; name: string; avatarURL: string } | null;
  } | null;
};
...
export function useGetLessonBySlugQuery(
  baseOptions?: Apollo.QueryHookOptions<GetLessonBySlugQuery, GetLessonBySlugQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useGetLessonBySlugLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetLessonBySlugQuery, GetLessonBySlugQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetLessonBySlugQuery, GetLessonBySlugQueryVariables>(
    GetLessonBySlugDocument,
    options,
  );
}
...
export function useGetLessonsQuery(
  baseOptions?: Apollo.QueryHookOptions<GetLessonsQuery, GetLessonsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useGetLessonsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetLessonsQuery, GetLessonsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
